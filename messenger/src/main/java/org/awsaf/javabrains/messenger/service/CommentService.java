...
import org.awsaf.javabrains.messenger.model.Comment;
...
public class CommentService {
	...
	public Comment getComment(long messageId, long commentId) {
		...
		ErrorMessage errorMessage = new ErrorMessage("http://javabrains.koushik.org", "Not found", 404);
		Response response = Response.status(Status.NOT_FOUND)
									.entity(errorMessage)
									.build();
		
		Messages message = messages.get(messageId);
		if(message == null) {
